(function() {
    ...
    // 1. НАСТРОЙКИ И ФРАЗЫ (В самом верху, чтобы точно работало)
    var Defined = {
        api: 'lampac',
    ...
    function account(url) {
        ...
        if (url.indexOf('token=') == -1) {
            var token = 'f8lgdpq2';
            if (token != '') url = Lampa.Utils.addUrlComponent(url, 'token=f8lgdpq2');
        }
